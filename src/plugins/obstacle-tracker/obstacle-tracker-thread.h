...
#ifndef __PLUGIN_OBSTACLE_TRACKER_THREAD_H_
#define __PLUGIN_OBSTACLE_TRACKER_THREAD_H_
  ...
  public fawkes::TransformAspect
{
 ...
 public:
  ObstacleTrackerThread();
  virtual ~ObstacleTrackerThread();
