/***************************************************************************
 *  ObstacleTracker_thread.cpp - Graph-based global path planning
 *
...
/** @class ObstacleTrackerThread "ObstacleTracker_thread.h"
 * Thread to track moving obstacles.
 * @author Sebastian Reuter
 */

/** Constructor. */
ObstacleTrackerThread::ObstacleTrackerThread()
  : Thread("ObstacleTrackerThread", Thread::OPMODE_WAITFORWAKEUP),
...
void
ObstacleTrackerThread::finalize()
{
...
void
ObstacleTrackerThread::once()
{
}

void
ObstacleTrackerThread::loop()
{
